...
abstract class KaptGenerateStubsTask @Inject constructor(
    ...
    @get:Internal
    internal abstract val kotlinSources: ConfigurableFileCollection
    ...
    private val jvmSourceRoots by project.provider {
        SourceRoots.ForJvm(
            kotlinSources.filter { isSourceRootAllowed(it) },
            javaSourceRoots.filter { isSourceRootAllowed(it) }
        )
    }
