...
internal open class KotlinTasksProvider {
    ...
    fun registerKotlinJSTask(
        project: Project, kotlinOptions: KotlinCommonOptions, configuration: Kotlin2JsCompileConfig
    ...
    fun registerKotlinJsIrTask(
        project: Project, configuration: KotlinJsIrLinkConfig
    ...
    fun registerKotlinCommonTask(
        project: Project, kotlinOptions: KotlinCommonOptions, configuration: KotlinCompileCommonConfig
