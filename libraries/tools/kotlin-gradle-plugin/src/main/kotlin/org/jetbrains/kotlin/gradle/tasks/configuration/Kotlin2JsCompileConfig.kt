...
internal open class BaseKotlin2JsCompileConfig<TASK : Kotlin2JsCompile>(
    ...
    override val incremental: Property<Boolean> = objectFactory.property(propertiesProvider.incrementalJs ?: true)

    private val incrementalJsKlib: Property<Boolean> = objectFactory.property(propertiesProvider.incrementalJsKlib ?: true)
