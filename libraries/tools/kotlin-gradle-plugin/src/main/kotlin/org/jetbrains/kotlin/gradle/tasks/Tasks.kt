...
abstract class AbstractKotlinCompile<T : CommonCompilerArguments> : AbstractKotlinCompileTool<T>(),
    ...
    @get:LocalState
    abstract val taskBuildDirectory: DirectoryProperty
...
abstract class KotlinCompile @Inject constructor(
    ...
    abstract val parentKotlinOptions: Property<KotlinJvmOptions>

//    @get:Internal("Takes part in compiler args.")
//    abstract val customPluginOptions: Property<CompilerPluginOptions>
