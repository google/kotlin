...
class SplayLauncher : Launcher() {
    override val baseBenchmarksSet = mutableMapOf<String, AbstractBenchmarkEntry>(
        "Splay" to BenchmarkEntryWithInitAndValidation.create(::Splay, { runSplay() }, { splayTearDown() }),
    )
}

fun main(args: Array<String>) {
    val launcher = SplayLauncher()
